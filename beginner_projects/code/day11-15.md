...
#TODO 1: Data keys name, follower_count, description, country; take the variables randomly and assign randomly datas to A and B

#TODO 2: There is one input=user_answer again and again until game finished: even it is lower make it work "Who has more followers? Type 'A' or 'B': "

#TODO 3: Print: name, description and country and compare their followers! Compare A: {name=Cardi B}, {description: a Musician}, from {country: United States}., Against B: Virat Kohli, a Cricketer, from India.

#TODO 4: Create a function for compare(user_answer, comp_answer)

#TODO 5: There is two option A and B

#TODO 6: If the user choose A or B put on the function

#TODO 7: Always compare the follower in data A<B or A>B if the user answer is true keep playing

#TODO 8: If user answer is not true finish it and write final score "Sorry, that's wrong. Final score: 2"

#TODO 9: Print logo just once and vs every time
